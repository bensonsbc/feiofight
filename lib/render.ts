...
export class Renderer{
 atlas!:Atlas;bg!:HTMLImageElement;chicken!:Sprite;wolf!:Sprite;bike!:Sprite;ready=false;
 async load(){const [hiro,marica,defense,lobao,ratao,bg]=await Promise.all([image("/assets/hiro-sheet.png"),image("/assets/marica-sheet.png"),image("/assets/marica-defense.png"),image("/assets/lobao-sheet.png"),image("/assets/ratao-sheet.png"),image("/assets/arena.png")]);this.bg=bg;this.atlas={hiro:{},marica:{},lobao:{},ratao:{}};
