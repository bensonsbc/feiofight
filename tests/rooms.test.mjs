...
for(const [hostHero,guestHero] of [['marica','lobao'],['lobao','hiro'],['ratao','marica']]){
...
console.log('Roster checks passed: Lobão and Ratão selections, duplicate/invalid selection rejected, spectator sees chosen characters.');
