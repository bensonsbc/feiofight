...
for(const [hostHero,guestHero] of [['marica','lobao'],['lobao','hiro'],['ratao','marica'],['bale','ratao']]){
...
console.log('Roster checks passed: Lobão, Ratão and Bale selections, duplicate/invalid selection rejected, spectator sees chosen characters.');
